...
enum TileFlags
{
	...
	TileFlag_FlipY = 0x0002,
	TileFlag_Solid = 0x0004,
	//Blank			= 0x00000008,
	TileFlag_ImpassibleNorth = 0x0010,
	TileFlag_ImpassibleEast = 0x0020,
	TileFlag_ImpassibleSouth = 0x0040,
	TileFlag_ImpassibleWest = 0x0080,
	//Blank			= 0x00000100,
	//Blank			= 0x00000200,
	//Blank			= 0x00000400,
	//Blank			= 0x00000800,
