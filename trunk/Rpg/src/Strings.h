...
/*
 * Contains strings of all the defined terminology used in the game (and the editor).
 */
class Strings
{
public:
	...
	void SerializeXml( XmlWriter* xml )
	{
		...
		SerializeStringArray(xml, "ClassFlags", class_flags, MAX_CLASS_FLAGS);
		SerializeStringArray(xml, "FamilyFlags", family_flags, MAX_FAMILY_FLAGS);
	...
	void DeserializeXml( XmlReader* xml )
	{
		...
		{
			DeserializeStringArray(xml, "Stats", stats, MAX_STATS);
			DeserializeStringArray(xml, "Elements", elements, MAX_ELEMENTS);
			DeserializeStringArray(xml, "Status", status, MAX_STATUS);
			DeserializeStringArray(xml, "ClassFlags", class_flags, MAX_CLASS_FLAGS);
			DeserializeStringArray(xml, "FamilyFlags", family_flags, MAX_FAMILY_FLAGS);
